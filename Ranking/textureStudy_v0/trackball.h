...
/// Short for trackball initialization.
/// This function sets up the trackball.
...
void tbMotion(int x, int y, int button);

void tbAnimate(GLboolean animate);

/// Move the trackball in a given direction.
/// @param dx the amount to move the trackball along the x axis
/// @param dy the amount to move the trackball along the y axis
void translate(float dx, float dy);

/// Zoom in using the trackball.
/// @param the amount to zoom in
void tbZoom(float dy);

extern GLfloat zoom;
extern GLfloat tbx; /**< the current x position of the trackball */
extern GLfloat tby; /**< the current y position of the trackball */
