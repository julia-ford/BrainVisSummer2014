...
int main(int argc, char** argv){
	...
	/*
	if(!isTraining){
		displayManager.LoadData("C:/Users/Guohao Zhang/Desktop/data/traces/data",
			"C:/Users/Guohao Zhang/Desktop/Dropbox/data/normal_s3_switched.tensorinfo",
			"C:/Users/Guohao Zhang/Desktop/Dropbox/data/forallfb.data");
		BoysSurfaceColorScheme::LoadFromFile(
			"C:/Users/Guohao Zhang/Desktop/Dropbox/data/normal_s3_boy.data");
		displayManager.LoadLegend("C:/Users/Guohao Zhang/Desktop/Dropbox/data/boysLegend");
	}
	else{
		displayManager.LoadData("C:/Users/Guohao Zhang/Desktop/data/traces/data",
			"C:/Users/Guohao Zhang/Desktop/Dropbox/data/normal_s4_switched.tensorinfo",
			"C:/Users/Guohao Zhang/Desktop/Dropbox/data/forallfb.data");
		BoysSurfaceColorScheme::LoadFromFile(
			"C:/Users/Guohao Zhang/DeskTop/Dropbox/data/normal_s4_boy.data");
		displayManager.LoadLegend("C:/Users/Guohao Zhang/DeskTop/Dropbox/data/boysLegend");
	}
	*/
	string prefixPath = "";//"C:/Users/Administrator/Dropbox/Programs/Ranking/textureStudy_v0/";
	string dataDir = prefixPath+"RankingData/traces/data";
	//string dataDir = "C:/Users/GuohaoZhang/Desktop/data/traces3/data";
	string traceDir = prefixPath+"RankingData/templates";
	if(!isTraining){
